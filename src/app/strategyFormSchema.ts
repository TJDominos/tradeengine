...
export const STRATEGY_FIELD_SCHEMAS: StrategyFieldSchema[] = [
  ...
  },
  {
    ...
    section: 'parameters',
    label: 'Operating Window (Hours)',
    description: 'Enter 1-168 hours. Common windows are 4 hours and 1 day; only 24h aggregate metrics are currently available for live qualification.',
    fieldType: 'number',
    capability: 'partial',
    editable: true,
    options: [
