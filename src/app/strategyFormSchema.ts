...
export const STRATEGY_FIELD_SCHEMAS: StrategyFieldSchema[] = [
  ...
  },
  {
    ...
    description: 'Enter a window from 1 minute to 7 days. The same window controls scheduling and live qualification.',
    fieldType: 'text',
    capability: 'partial',
    editable: true,
    options: [
  ...
  },
  {
    ...
    description: 'Uses confirmed webhook transaction volume from the selected operating window.',
    fieldType: 'number',
    capability: 'supported',
    editable: true,
  },
  {
    ...
    section: 'targets',
    label: 'Net Buy/Sell Target (USDC)',
    description: 'Accumulation treats this as net buy-in. Distribution treats this as net sell-out.',
    fieldType: 'number',
    capability: 'partial',
    editable: true,
  },
