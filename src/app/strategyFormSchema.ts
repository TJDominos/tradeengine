...
export const STRATEGY_FIELD_SCHEMAS: StrategyFieldSchema[] = [
  ...
  {
    id: 'externalBuyAction',
    path: 'triggers.onExternalBuy',
    section: 'triggers',
    label: 'External BUY Response',
    description: 'Action applied when a confirmed external BUY clears the trigger floor.',
    fieldType: 'select',
    capability: 'supported',
    editable: true,
    options: [
  ...
  {
    id: 'externalSellAction',
    path: 'triggers.onExternalSell',
    section: 'triggers',
    label: 'External SELL Response',
    description: 'Action applied when a confirmed external SELL clears the trigger floor.',
    fieldType: 'select',
    capability: 'supported',
    editable: true,
    options: [
